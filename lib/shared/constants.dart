...
import 'package:GuardianAngel/services/shake.dart';
...
class Constants {
  static IconData hospitalIcon = Icons.control_point_duplicate;
  ...
  static IconData tipsIcon = Icons.perm_device_information;
  ...
  static Function sendMessage = () async {
    ...
    List<String> recipents = ["8218521910"];

    SmsSender sender = SmsSender();
    String address = recipents[0];
    sender.sendSms(SmsMessage(address, message));

    const number = '8218521910'; //set the number here
